...
func log(_ msg: String) { AppLog.shared.append("[shw] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/shw/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/shw/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("shw", forHTTPHeaderField: "User-Agent")
