...
struct ContentView: View {
    ...
    private enum GameMode: String, CaseIterable {
        ...
        var patchPrefix: String { self == .normal ? "shw" : "OGIOS" }
    ...
    private var developerCredits: some View {
        VStack(spacing: 10) {
            ...
            HStack(spacing: 10) {
                channelButton(title: "shw Discord", url: "https://discord.gg/2dm2zJgkkq")
            }
        }
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text("Digite a senha uma vez para desbloquear este pacote shw neste dispositivo.")
                }
            }
